<template>
    <b-modal id="correct-data" ref="correct-data" title="Corrigir dados" size="lg" 
        header-bg-variant="info" header-text-variant="light" ok-only @ok="handleOk">
        ...
        <form @submit.stop.prevent="formSubmited">
            ...
            <div>
                ...
                <div class="selected-data">
                    <p v-for="(value, index) in selected" :key="index">
                        {{ value }}, 
                    </p>
                </div>
            </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                options: [
                    ...
                    {text: 'Lotação (Superintendência)', value: 'Lotação (Superintendência)'},
                    {text: 'Lotação (Seccional)', value: 'Lotação (Seccional)'},
                    {text: 'Unidade em que trabalha', value: 'Unidade em que trabalha'},
                    {text: 'Município em que trabalha', value: 'Município em que trabalha'},
                    {text: 'Cep', value: 'Cep'},
                    {text: 'Rua', value: 'Rua'},
        ...
        methods: {
            ...
            formSubmited() {
                ...
                this.$http.post('associated/correct-data',form, {
                    headers: {
