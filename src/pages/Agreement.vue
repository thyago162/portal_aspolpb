          ...
          <b-form-group>
            <b-form-select class="ml-3" v-model="selected" >
              ...
              <b-form-select-option
                v-for="(citie,index) in cities"
                :value="citie.nm_city"
                :key="index"
              >{{citie.nm_city}}</b-form-select-option>
            </b-form-select>
          </b-form-group>
        </b-form>
      </b-col>
    ...
    <b-row class="ml-1 mr-1">
      <b-col>
        <div class="agreement-card mt-3">
          <AgreementCard :item="agreement" v-for="(agreement,index) in agreements" :key="index" />
        </div>
      </b-col>
    </b-row>
  </b-container>
    ...
    agreements: function() {
      if (this.selected) {
        ...
        return agreement.filter(param => {
          ...
          window.console.log('entrou na exceção')
